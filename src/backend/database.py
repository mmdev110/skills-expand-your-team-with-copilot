...
def init_database():
    ...
    if activities_collection.count_documents({}) == 0:
        ...
        for name, difficulty in activity_difficulties.items():
            existing = activities_collection.find_one({"_id": name}, {"difficulty": 1})
            if existing and existing.get("difficulty") != difficulty:
...
initial_activities = {
    ...
    "Manga Maniacs": {
        "description": "Dive into heroic quests, mind-bending mysteries, and heartfelt journeys inspired by legendary Japanese manga characters.",
